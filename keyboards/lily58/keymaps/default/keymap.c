 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LSPO,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MPLY,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSPC, \
                             KC_LALT, MO(_LOWER), KC_LGUI, KC_SPC,   KC_ENT,   KC_BSPC, MO(_RAISE),  TT(_RAISE) \
),
